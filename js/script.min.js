...
$(window).on('scroll',function(){counter();});$(document).ready(function(){$('.has-animation').each(function(index){$(this).delay($(this).data('delay')).queue(function(){$(this).addClass('animate-in');});});});$(document).ready(function(){$(".publications__button").click(function(){let buttonText=$(this).text();$(this).text(buttonText=="View publications"?"Hide publications":"View publications");})});})(jQuery);